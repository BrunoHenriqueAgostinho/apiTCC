...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "SELECT 
                ...
                T.margemDireita_trabalho as margemDireita,
                T.margemEsquerda_trabalho as margemEsquerda,
                T.margemTopo_trabalho as margemTopo,
                T.margemBaixo_trabalho as margemBaixo,
    ...
    if ($contador == 0){
        ...
        //Não foi possível consultar seus trabalhos
        echo json_encode(["erro" => "Houve um problema ao listar os usuários e seus trabalhos"]);
    } else {
