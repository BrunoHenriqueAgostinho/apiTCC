...
CREATE TABLE IF NOT EXISTS `Academic2`.`Tb_Instituicao` (
  ...
  `estado_instituicao` VARCHAR(60) NULL,
  `cidade_instituicao` VARCHAR(60) NULL,
  `bairro_instituicao` VARCHAR(60) NULL,
  `rua_instituicao` VARCHAR(60) NULL,
  `numero_instituicao` VARCHAR(10) NULL,
  `complemento_instituicao` VARCHAR(60) NULL,
  `cep_instituicao` CHAR(8) NULL,
